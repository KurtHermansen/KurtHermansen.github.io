const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=cb1e61a118d4bf7f7b819f989206909f';
...
fetch(apiURL)
  ...
  const apiURL2 = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=cb1e61a118d4bf7f7b819f989206909f';
...
fetch(prestonEventURL)
    ...
    .then(function(jsObject){
        ...
        const events = jsObject['towns']['2']['events'];
